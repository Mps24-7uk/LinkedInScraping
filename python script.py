...
def get_user_detail(user_detail_list):
    ...
    email.send_keys("    ") ########## enter your  linkedIn username 
    ...
    for l1 in user_detail_list:
        ...
        time.sleep(4)
        element = driver.find_element_by_id('experience-section')
...
Detail.to_csv("linkedin_complete_output1.csv", encoding='utf-8', index=False)	
